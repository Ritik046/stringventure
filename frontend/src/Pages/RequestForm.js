...
const RequestForm = () => {
  ...
  return (
    <>
      <Header />
      <div className="w[100%] h-[100%] flex md:flex-col-reverse justify-start items-center bg-gradient-to-b from-gray-800 to-gray-600 pt-[130px] md:pl-5 sm:pl-0 md:pt-[80px] pb-20">
